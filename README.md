...
[Product overview](docs/PRODUCT.md) · [Build the app](macos/README.md) · [Website](website/README.md) · [Documentation](docs/README.md) · [Security](SECURITY.md)
...
Download **[Tabnax.dmg](https://github.com/danmartuszewski/tabnax/releases/latest/download/Tabnax.dmg)** from the [latest release](https://github.com/danmartuszewski/tabnax/releases/latest), open it, and drag Tabnax to Applications. Or use Homebrew:
