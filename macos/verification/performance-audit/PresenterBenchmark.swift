...
@main @MainActor struct PresenterBenchmark {
    static func main() {
        ...
        let output: [String: Any] = ["mode": mode.rawValue, "windows": count, "warmed_assets": warmedAssets, "samples": values, "scope": "previewOnly; present and forced layout only, no WindowServer order or physical key"]
